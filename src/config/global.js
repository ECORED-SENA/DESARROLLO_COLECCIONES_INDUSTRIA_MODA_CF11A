  ...
  menuPrincipal: {
    menu: [
      ...
      },
      {
        ...
        icono: 'far fa-file-alt',
        numero: '2',
        titulo: 'Desarrollo de geometrales',
        desarrolloContenidos: true,
      },
      {
        nombreRuta: 'tema3',
      ...
      },
      {
        ...
        icono: 'far fa-file-alt',
        numero: '4',
        titulo: 'Manejo de textos y desarrollo de efectos',
        desarrolloContenidos: true,
      },
      {
        nombreRuta: 'tema5',
      ...
      },
      {
        ...
        icono: 'far fa-file-alt',
        numero: '6',
        titulo: 'Dibujo de figurín y desarrollo de modelos',
        desarrolloContenidos: true,
      },
    ],
    subMenu: [
